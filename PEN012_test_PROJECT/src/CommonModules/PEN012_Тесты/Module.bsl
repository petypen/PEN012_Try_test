...
Функция Тест(НаименованиеТеста, КоличествоПовторенийТеста) Экспорт
	...
	// Без исключения
	СИсключительнойСитуацией = Ложь;
	Для Индекс = 1 По КоличествоПовторенийТеста Цикл
		Длительность = ВыполнитьТестСЗамеромВремени(НаименованиеТеста, ИТЕРАЦИИ, СИсключительнойСитуацией);
	...
	// С исключением
	СИсключительнойСитуацией = Истина;
	Для Индекс = 1 По КоличествоПовторенийТеста Цикл
		Длительность = ВыполнитьТестСЗамеромВремени(НаименованиеТеста, ИТЕРАЦИИ, СИсключительнойСитуацией);
		СтрокаТаблицы = ТаблицаРезультатов.Получить(Индекс - 1);
		СтрокаТаблицы.Итерация = Индекс;
...
Функция ВыполнитьТестСЗамеромВремени(НаименованиеТеста, Итерации, СИсключительнойСитуацией)
	...
	Для Индекс = 1 По Итерации Цикл
		...
		Попытка
			МодульТеста.СценарийТеста(Индекс, СИсключительнойСитуацией);
		Исключение
