...
&НаКлиенте
Процедура Команда_Тест3(Команда)
	Команда_Тест3НаСервере();
КонецПроцедуры


&НаКлиенте
Процедура Команда_Тест4(Команда)
	Команда_Тест4НаСервере();
КонецПроцедуры
...
&НаСервере
Процедура Команда_Тест3НаСервере()

	НаименованиеТеста = "Вызов исключения как оператора";
	КоличествоПовторенийТеста = 10;
	ТаблицаРезультатов = PEN012_Тесты.Тест(НаименованиеТеста, КоличествоПовторенийТеста);
	ВывестиДиаграмму(ТаблицаРезультатов, НаименованиеТеста);
...
&НаСервере
Процедура Команда_Тест4НаСервере()

	НаименованиеТеста = "Вызов исключения как функции";
	КоличествоПовторенийТеста = 10;
	ТаблицаРезультатов = PEN012_Тесты.Тест(НаименованиеТеста, КоличествоПовторенийТеста);
	ВывестиДиаграмму(ТаблицаРезультатов, НаименованиеТеста);
